...
for lb in $(seq 4 1 10) 
	do
			...
			# python -W ignore ./embedding/dynRNN.py -iter 250 -l 50 -lb $lb -emb 128 -sm $sm 2000 -rd ./resultsdynRNN_lookback_hep -t hep
			python -W ignore ./embedding/dynRNN.py -iter 250 -l 50 -lb $lb -emb 128 -sm $sm 2000 -rd ./resultsdynRNN_lookback_AS -t AS
