...
The paper showcasing the results of dyngraph2vec can be accesses through [dyngraph2vec: Capturing Network Dynamics using Dynamic Graph Representation Learning](https://arxiv.org/abs/1809.02657)
