...
* The TIMERS is originally writtien in matlab, in dynamicgem we have created python modules for Timers using Matlab Library Compiler. We have used Matlab R2017a to generate modules that work with python 3.5. To run the matlab runtime please configure the Matlab runtime as mentioned in the website "https://www.mathworks.com/products/compiler/matlab-runtime.html"
