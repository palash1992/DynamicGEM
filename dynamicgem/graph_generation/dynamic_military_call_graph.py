...
def resample_edges(call_graph, percent_resampled_edges):
	...
	idx = 0
	idx2 = 0
	call_graph, idx, idx2 = _resample_subgraph(call_graph, sampled_edge_indices, call_graph._commander_subgraph, idx, idx2, 0, call_graph._n_commanders)
	call_graph, idx, idx2 = _resample_subgraph(call_graph, sampled_edge_indices, call_graph._soldier_subgraph, idx, idx2, call_graph._n_commanders, call_graph._n_soldiers)
	call_graph, idx, idx2 = _resample_subgraph(call_graph, sampled_edge_indices, call_graph._family_subgraph, idx, idx2, call_graph._n_military, call_graph._n_family_members)
...
def get_dynamic_military_call_graph(percent_resampled_edges, inc_factor, n_peace, n_plan, n_order, n_event):
	...
	graph_current = static_military_call_graph.StaticMilitaryGraph(1000, 100, 10, 1, [0.2]*3, [0.01]*3, 0.1, 0.1)# Fill it with initial param mitras
