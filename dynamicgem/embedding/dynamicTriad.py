...
from dyngraph2vec.dynamictriad.core import *
from six.moves import cPickle
import importlib
from os.path import isfile
import dyngraph2vec.dynamictriad.core.dataset.dataset_utils as du
import dyngraph2vec.dynamictriad.core.algorithm.embutils as eu
from  dyngraph2vec.dynamictriad.scripts.stdtests import StdTests
from dyngraph2vec.evaluation import evaluate_link_prediction as lp
import pdb
...
class dynamicTriad(StaticGraphEmbedding):
    ...
    def learn_embedding(self):
        ...
        if self._pretrain_size > 0:
            ...
            validargs = tm.dataset.sample_test_data(self._validation, initstep, initstep + self._pretrain_size, size=10000)
            #print(validargs)
    ...
    def get_embedding(self):
        self._X=dataprep_util.getemb_dynTriad(self._outdir+'/'+self._testDataType+'/dynTriad', self._nsteps, self._embdim)
        return self._X
